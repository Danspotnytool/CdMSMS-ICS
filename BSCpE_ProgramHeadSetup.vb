...
Public Class BSCpE_ProgramHeadSetup
    ...
    Protected Sub BSCpE_ProgramHeadSetup_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Name = "BSCpE Program Head Setup"
    ...
    Protected Sub BSCpE_ProgramHeadSetup_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        If Me.Loaded Then
            Dim i As Integer = 0
