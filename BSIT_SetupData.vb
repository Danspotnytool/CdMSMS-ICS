...
Public Class BSIT_SetupData
    Inherits BaseForm

    Private FormPanel As New Transparent.FlowLayoutPanel

    Protected Sub BSIT_SetupData_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Name = "Setup BSIT Data"

        Dim Title As New Label With {
            .Text = "Import BSIT Data",
            .AutoSize = True,
    ...
    Protected Sub BSIT_SetupData_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        If Me.Loaded Then
